...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小旭', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '立志成为全沾程序员🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.rookiexu.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客, 随记, Notion, 成长', // 网站关键词 英文逗号隔开
